package com.sanrenzu.chunbo.activity;
...
import com.sanrenzu.chunbo.fragment.FenleiFragment;
import com.sanrenzu.chunbo.fragment.GouwucheFragment;
import com.sanrenzu.chunbo.fragment.MeishiFragment;
import com.sanrenzu.chunbo.fragment.ShouyeFragment;
import com.sanrenzu.chunbo.fragment.WodeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_main_meishi;
    ...
    private static final int SELECTED_MEISHI = 2;
    private static final int SELECTED_GOUWUCHE = 3;
    private static final int SELECTED_WODE =4;
    ...
    private void initView() {
        ...
        btn_main_meishi= (Button) findViewById(R.id.btn_main_meishi);

        btn_main_home.setSelected(true);
        btn_main_home.setTextColor(Color.parseColor("#32BE6E"));
        btn_main_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_main_meishi.setSelected(false);
                ...
                btn_main_meishi.setTextColor(Color.parseColor("#000000"));
                selectFragment(SELECTED_SHOUYE);
            }
        });
        btn_main_live.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_main_live.setTextColor(Color.parseColor("#32BE6E"));
                btn_main_follow.setTextColor(Color.parseColor("#000000"));
                btn_main_mine.setTextColor(Color.parseColor("#000000"));
                btn_main_meishi.setTextColor(Color.parseColor("#000000"));
        ...
        btn_main_meishi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btn_main_home.setSelected(false);
                btn_main_live.setSelected(false);
                btn_main_follow.setSelected(false);
                btn_main_mine.setSelected(false);
                btn_main_meishi.setSelected(true);

                btn_main_home.setTextColor(Color.parseColor("#000000"));
                btn_main_live.setTextColor(Color.parseColor("#000000"));
                btn_main_follow.setTextColor(Color.parseColor("#000000"));
                btn_main_mine.setTextColor(Color.parseColor("#000000"));
                btn_main_meishi.setTextColor(Color.parseColor("#32BE6E"));
                selectFragment(SELECTED_MEISHI);
            }
        });
        btn_main_follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_main_home.setTextColor(Color.parseColor("#000000"));
                btn_main_live.setTextColor(Color.parseColor("#000000"));
                btn_main_follow.setTextColor(Color.parseColor("#32BE6E"));
                btn_main_mine.setTextColor(Color.parseColor("#000000"));
                btn_main_meishi.setTextColor(Color.parseColor("#000000"));
        ...
        btn_main_mine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_main_live.setTextColor(Color.parseColor("#000000"));
                btn_main_follow.setTextColor(Color.parseColor("#000000"));
                btn_main_mine.setTextColor(Color.parseColor("#32BE6E"));
                btn_main_meishi.setTextColor(Color.parseColor("#000000"));
    ...
    private void initFragment() {
        ...
        meishiFragment = new MeishiFragment();
        ...
        transaction.add(R.id.layout_container, meishiFragment);
    ...
    private void selectFragment(int position) {
        ...
        FragmentTransaction transaction = manager.beginTransaction();
        //将所有的碎片先隐藏
        transaction.hide(shouyeFragment).hide(fenleiFragment).hide(meishiFragment).hide(gouwucheFragment).hide(wodeFragment);
        switch (position) {
            //根据选择的小标，显示碎片
            ...
            case SELECTED_FENLEI:
                ...
                break;
            case SELECTED_MEISHI:
                transaction.show(meishiFragment);
                break;
